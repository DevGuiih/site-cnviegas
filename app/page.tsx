        ...
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="relative max-w-xl">
            ...
            <input
              ...
              className="w-full pl-11 pr-16 py-3 bg-zinc-900 border border-zinc-800 rounded-xl text-sm text-white placeholder-zinc-500 focus:outline-hidden focus:border-red-600 transition-colors"
            />
            {searchQuery && (
              <button
